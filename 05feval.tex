...
above. Many participants replied “see above” or commented on the intuitive
...
(i) during the lesson, and (ii) after the lesson.} and \textit{US8: Reflecting on the class’s achievements and planning the next lesson.} 

As these are a more general questions, we asked participants to
provide comments only at the ``end of session'' questionnaire. 
9 out of 24 trainee teachers provided comments about both scenarios
 that implied that they would have to revert in solutions that require them
to either walk around the class and check all pupils' work or rely on
students asking for assistance. They commented on the effort this
requires and the fact that it would be difficult to check students'
work after class (they would need to organise where students save
their work and a way for them to access it). 3 participants said that
they would rely on peer interaction and direct discussions between the
students and 2 referred to more 'innovative' solutions like 'traffic
lights' (similar to the answers for US 1). 10 participants did not reply and
5 of them referred to the answers they would give in US 1 (for which
there is an obvious overlap). All of the 14 who provided answers
with respect to how these scenario can be achieved with the TA
tools showed appreciation of the functionalities and how they can be
combined to allow them to provide support during and after the
lesson. In particular, 5 of them said that they would look back 
after class to check which tasks were achieved and which were
problematic.
This would allow knowing where and how students are struggling (one of
them commented that this information could be taken into account for
the grouping).
Two partipants commented that the CD tool could help in making sure
that students 
who needs immediate help
during the lesson are supported and that for those with not
enough it would allow the teacher to plan to talk to them in the next
lesson.
Two commented explicitly on the fact that by seeing the
indicators allows them 
``to identify the most common mis-conceptions which could then be
consolidated in the following lesson'' although both referred to the
complexity of it for moment-to-moment classroom interaction.
Lastly, two participants commented positively on the real time help functionalities, 
which although strictly speaking is designed to support the students
and was not presented as part of the TA tools have of course
the potential to assist teachers in reducing their overload during
class. \ednote{write about' ``I wonder how much it indicates to the teacher 
...
comprised\ednote{I think the details here are not needed and perhaps
